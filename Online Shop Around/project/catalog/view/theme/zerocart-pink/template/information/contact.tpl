      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            ...
            <?php } ?>
            <div class="col-sm-3"><strong>Online Shop Around</strong><br />
              <address>
             Jahangirnagar university
		    Savar, Dhaka, 1342.

            Phone: 01948510890, 01914925013

             Email: ppharun@yahoo.com, rafiquecse20@yahoo.com
              </address>
              <?php if ($geocode) { ?>
            ...
            <div class="col-sm-3"><strong>01914925013</strong><br>
             <br />
              <br />
              <?php if ($fax) { ?>
